...
public class Reservation_check extends Activity {
        ...
        cancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!authenticationNum.equals("null")) {
                    try {
                        cancel_reservation(aes.AES_Encode(authenticationNum));
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
    ...
    public class AsyncReserCancel extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            ...
            mDlg.setMessage("Canceling reservation..");
            mDlg.show();
            super.onPreExecute();
        }
    ...
    public class AsyncReserCheck extends AsyncTask<String, Integer, String> {
        ...
        protected void onPreExecute() {
            mDlg = new ProgressDialog(Reservation_check.this);
            mDlg.setProgressStyle(ProgressDialog.STYLE_SPINNER);
            mDlg.setMessage("Checking reservation..");
            mDlg.show();
            super.onPreExecute();
        }
        ...
        protected String doInBackground(String... params) {
            ...
            Log.i("abc", "check_doinBackground");
        ...
        protected void onPostExecute(String str) {
            try {
                ...
                Log.i("abc", "checkReservation_OnPost:" + str);
                if (check_rri != null) {
                    if (!check_rri.getParkingslot_id().equals("NULL")) {
                        ...
                        authenticationNum = aes.AES_Decode(check_rri.getResv_authenticationnum());
                    ...
                    } else if (str.equals("False") || ns.flag == 0) {
                        checkFlag = 1;
                        editor.putInt("flag", 0);
                        editor.commit();
                        Log.i("abc", "Reservation check connection fail");
                    ...
                    checkFlag = 1;
                    editor.clear();
                    Log.i("abc", "Reservation check result=null");
                    editor.putBoolean("Reservation", false);
                    editor.commit();
    ...
    protected void onResume() {
        ...
        if (checkFlag == 0 || pref.getInt("flag", 3) == 1) {

            phone_num = pref.getString("phoneNum", null);
            try {
                ...
                /*
                    ...
                    Log.i("abc", "ReserveTime:" + reservedTime + "ParkingFacility" + parkingFacility + "Parkingslot:" + parkingSlot);
